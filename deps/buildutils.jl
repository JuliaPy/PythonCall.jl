...
const JULIA_PYTHON_DEBUG_BUILD = "yes" == get(ENV, "JULIA_PYTHON_DEBUG_BUILD", "no")
...
function find_libpython(python::AbstractString; _dlopen = Libdl.dlopen)
    ...
    for lib in libs
        ...
        try
            ...
            # Python.jl trying to use.  It also helps PyJulia to
            # compare libpython.
    ...
    error("""
        ...
        Re-building with
            ENV["JULIA_PYTHON_DEBUG_BUILD"] = "yes"
