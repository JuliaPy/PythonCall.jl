...
pyjl_handle_error_type(::typeof(pyjlio_close), io, exc) = exc isa MethodError && exc.f === close ? pybuiltins.ValueError : PyNULL

pyjlio_closed(io::IO) = Py(!isopen(io))
pyjl_handle_error_type(::typeof(pyjlio_closed), io, exc) = exc isa MethodError && exc.f === isopen ? pybuiltins.ValueError : PyNULL

pyjlio_fileno(io::IO) = Py(fd(io))
pyjl_handle_error_type(::typeof(pyjlio_fileno), io, exc) = exc isa MethodError && exc.f === fd ? pybuiltins.ValueError : PyNULL

pyjlio_flush(io::IO) = (flush(io); Py(nothing))
pyjl_handle_error_type(::typeof(pyjlio_flush), io, exc) = exc isa MethodError && exc.f === flush ? pybuiltins.ValueError : PyNULL

pyjlio_isatty(io::IO) = Py(io isa Base.TTY)

pyjlio_readable(io::IO) = Py(isreadable(io))
pyjl_handle_error_type(::typeof(pyjlio_readable), io, exc) = exc isa MethodError && exc.f === isreadable ? pybuiltins.ValueError : PyNULL
...
pyjl_handle_error_type(::typeof(pyjlio_seek), io, exc) = exc isa MethodError && (exc.f === position || exc.f === seek || exc.f === seekend) ? pybuiltins.ValueError : PyNULL

pyjlio_tell(io::IO) = Py(position(io))
pyjl_handle_error_type(::typeof(pyjlio_tell), io, exc) = exc isa MethodError && exc.f === position ? pybuiltins.ValueError : PyNULL
...
pyjl_handle_error_type(::typeof(pyjlio_truncate), io, exc) = exc isa MethodError && (exc.f === position || exc.f === truncate) ? pybuiltins.ValueError : PyNULL
...
pyjl_handle_error_type(::typeof(pyjltextio_read), io, exc) = exc isa MethodError && exc.f === read ? pybuiltins.ValueError : PyNULL
...
pyjl_handle_error_type(::typeof(pyjltextio_readline), io, exc) = exc isa MethodError && exc.f === read ? pybuiltins.ValueError : PyNULL
