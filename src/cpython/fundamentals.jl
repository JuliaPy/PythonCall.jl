...
PyImport_ImportModuleLevelObject(name,globals,locals,from,level) = ccall(POINTERS.PyImport_ImportModuleLevelObject, PyPtr, (PyPtr, PyPtr, PyPtr, PyPtr, Cint), name, globals, locals, from, level)
